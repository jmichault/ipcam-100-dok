...
# _IMP\_ISP_   \( siehe   _imp\_isp.h\_)
...
```
* Schritt 3: Aktivieren Sie den Sensor, er produziert Bilder. 
...
```
* Schritt 5: Rufen Sie eine ISP-Debugging-Schnittstelle an: Bitte beachten Sie die Dokumentation einer ISP-Debugging-Schnittstelle. 




## ISP-Modul Deaktivierung.
...
```
* Schritt 2: Schließen Sie die Sensoren.   \( Frames müssen vor diesem Vorgang  \)  geschlossen sein 
...
```
* Schritt 4: Reinigen Sie das ISP-Modul, alle Sensoren müssen vor diesem Vorgang entfernt werden. 
